...
export default {
  ...
  methods: {
    ...
    async edit(companyId) {
      ...
      try {
        const response = await axios.post(
          "https://verbumscript.app:8080/api/frontend/getOneCompany",
          {
            token: "test",
            companyId: companyId,
          }
    ...
    async deleteUser(id) {
      ...
      try {
        const response = await axios.post(
          "https://verbumscript.app:8080/api/frontend/deleteCompany",
          {
            packetsId: id,
            token: "test",
          }
        ...
        this.notify("Company deleted successfully!", "success");
      } catch (error) {
    ...
    async saveChanges(oneCompany, id) {
      ...
      try {
        ...
        await axios.post(
          "https://verbumscript.app:8080/api/frontend/editCompany",
          data
        );
